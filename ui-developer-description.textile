...
* Familiarity with emerging web trends (HTML5, CSS3, responsive design, node.js, etc)
* Django expertise desired, understanding of web frameworks required
* Familiarity with mustache templates
